...
export class StorageService {
    ...
    getString(key: string, defaultValue?: string): Observable<string | undefined> {
        return this.storageMap.get<string>(this.addPrefix(key), { type: 'string' }).pipe(
            map(e => e == null ? defaultValue : e)
        );
    }

    getNumber(key: string, defaultValue?: number): Observable<number | undefined> {
        return this.storageMap.get<number>(this.addPrefix(key), { type: 'number' }).pipe(
            map(e => e == null ? defaultValue : e)
        );
    }

    getBoolean(key: string, defaultValue?: boolean): Observable<boolean | undefined> {
        return this.storageMap.get<boolean>(this.addPrefix(key), { type: 'boolean' }).pipe(
            map(e => e == null ? defaultValue : e)
        );
    }
