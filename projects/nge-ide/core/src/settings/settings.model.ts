...
export namespace Settings {
  ...
  export const defaults: Settings.Setting[] = [
    // Suggestion
    {
      ...
      value: true,
      comment:
        'Accept suggestions on provider defined characters. For example in JavaScript the semi-colon (;) is a commit character',
    },
    {
    ...
    },
    {
      ...
      type: Types.Dropdown,
      value: 'normal',
      comment: 'Controls the font weight.',
      choices: ['normal', 'bold', '100', '200', '300', '400', '500'],
    },
    ...
    },
    {
      ...
      type: Types.Dropdown,
      value: 'mouseover',
      comment: 'Control the behavior and rendering of the minimap.',
    ...
    },
    {
      ...
      type: Types.Dropdown,
      value: 'right',
      comment: 'Controls the side where to render the minimap.',
      choices: ['left', 'right'],
    },
    {
    ...
    },
    {
      ...
      type: Types.Dropdown,
      value: 'all',
      comment: 'Enable rendering of current line highlight.',
    ...
    },
    {
      ...
      type: Types.Dropdown,
      value: 'all',
      comment: 'Enable rendering of whitespace.',
      choices: ['none', 'boundary', 'all'],
    },
    {
      ...
      value: 30,
      comment:
        'When revealing the cursor, a virtual padding (px) is added to the cursor, turning it into a rectangle. This virtual padding ensures that the cursor gets revealed before hitting the edge of the viewport.',
    },
    {
    ...
    },
    {
      ...
      group: 'editor.scrollBar',
      type: Types.Number,
      value: 7,
      comment: 'Vertical size of the scrollbar in px',
    },
    {
      name: 'scrollbar.horizontalScrollbarSize',
      group: 'editor.scrollBar',
      type: Types.Number,
      value: 7,
    ...
    },
    {
      ...
      type: Types.Dropdown,
      value: 'on',
      comment: 'Enables tab completions.',
    ...
    },
    {
      ...
      type: Types.Checkbox,
      value: false,
      hidden: true, // TODO enabled after.
      comment:
