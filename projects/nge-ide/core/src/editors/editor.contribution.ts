...
import { ToolbarButton, ToolbarGroups, ToolbarSeparator, ToolbarService } from '../toolbar'
...
export class EditorContribution implements IContribution {
  ...
  activate(injector: Injector) {
    ...
    previewService.register(new SvgPreviewHandler(), new HtmlPreviewHandler(), new MarkdownPreviewHandler())
