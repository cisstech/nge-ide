...
export const EXPLORER_COMMAND_TOGGLE_FILTERING =
  'explorer.commands.toggle-filtering';
...
export class ExplorerCommandToggleFiltering implements ICommand {
  ...
  execute() {
    this.explorerService.adapter.enableKeyboardFiltering =
      !this.explorerService.adapter.enableKeyboardFiltering;
  }
}
