...
import { InfobarContainer, IView, ViewContainerScopes, ViewContainerService, ViewService } from '@cisstech/nge-ide/core'
...
export class InfobarComponent implements OnInit, OnDestroy {
  ...
  setActiveContainer(container: InfobarContainer): void {
    this.activeContainerIndex = this.containers.findIndex((e) => e.id === container.id)

    if (this.activeContainerView) {
      // no open on first load
